...
s3_client.delete_object(Bucket="unprotected-test-bucket", Key="Smudge.jpg")
...
s3_client.delete_object(Bucket="unprotected-test-bucket", Key="more_smudge/Other_Smudge.jpg")
...
s3_client.upload_file(smudge, "unprotected-test-bucket", "Smudge.jpg", ExtraArgs={"ACL": "public-read-write"})
s3_client.upload_file(other_smudge, "unprotected-test-bucket", "more_smudge/Other_Smudge.jpg", ExtraArgs={"ACL": "public-read-write"})
